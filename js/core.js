...
// Part of the LCARS Starbase modular split.
  ...
  const I18N = {
    en: {
      ...
      filmFormDirector:     'Director',
      filmFormDirectorPH:   'Director name…',
      filmFormRuntime:      'Runtime (min)',
      filmFormGenre:        'Genre',
      ...
      filmMin:              'min',
      filmMenuEdit:         'EDIT FILM',
      filmMenuDelete:       'DELETE FILM',
      ...
      bookFormCurrentPage:  'Current page',
    ...
    zh: {
      ...
      filmFormDirector:     '導演',
      filmFormDirectorPH:   '導演姓名…',
      filmFormRuntime:      '片長（分鐘）',
      filmFormGenre:        '類型',
